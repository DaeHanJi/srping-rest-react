        ...
        return (
            <div>
                ...
                <div id="createEmployee" className="modalDialog">
                    <div>
                        <a href="#" title="Colse" className="close">X</a>
...
class UpdateDialog extends React.Component {
    ...
    render() {
        const inputs = this.props.attributes.map(attribute =>
            <p key={attribute+this.props.employee.entity[attribute]}>
...
class EmployeeList extends React.Component {
    ...
    handleInput(e) {
        ...
        if (/^[0-9]+$/.test(pageSize)) {
            ...
            ReactDOM.findDOMNode(this.refs.pageSize).value = pageSize.substring(0, pageSize - 1);
        }
    }
